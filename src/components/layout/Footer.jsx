      ...
      <div className="container-page pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12">
          <div className="md:col-span-4">
            ...
            <p className="mt-6 text-sm leading-relaxed text-white/60 max-w-sm">
              An execution-led government contracting and infrastructure development group serving central
              ministries and Bihar state departments since 2003.
            </p>
            ...
            <div className="mt-8 space-y-3.5 text-sm">
              <div className="flex items-start gap-3">
                ...
                <span className="text-white/70">
                  Diarch House, R-Block, Patliputra Industrial Area,<br />
                  Patna, Bihar 800013
                </span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-accent flex-shrink-0" />
                <a href="tel:+916122500000" className="text-white/70 hover:text-accent transition-colors">
                  +91 612 250 0000
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-accent flex-shrink-0" />
                <a href="mailto:partnerships@diarchgroup.in" className="text-white/70 hover:text-accent transition-colors">
                  partnerships@diarchgroup.in
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-2">
            <h4 className="text-[11px] font-semibold uppercase tracking-[0.18em] text-accent mb-5">Company</h4>
            <ul className="space-y-3 text-[14px]">
              {[
                ...
                <li key={label}>
                  <Link to={href} className="text-white/70 hover:text-accent transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div className="md:col-span-2">
            <h4 className="text-[11px] font-semibold uppercase tracking-[0.18em] text-accent mb-5">Capabilities</h4>
            <ul className="space-y-3 text-[14px]">
              {[
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-[14px] text-white/65 leading-relaxed mb-5">
              For tender, partnership and contracting inquiries, contact our public-sector engagement desk.
            </p>
            <Link
              to="/partnerships"
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="text-[12px] text-white/45">
            © {new Date().getFullYear()} Diarch Group. All rights reserved. CIN: U45203BR2003PLC010742
          </div>
